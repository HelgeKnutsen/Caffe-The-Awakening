...
mod_def = 'data/DroneFlight1/NET/net_modified.prototxt' # path to model definitions-file 'models/bvlc_reference_caffenet/deploy.prototxt'
weights = 'data/DroneFlight1/NET/weights.pretrained.caffemodel' # path to weights-file, reference weights at 'models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
label_path = 'data/DroneFlight1/NET/test_names.txt' # 'data/ilsvrc12/synset_words.txt'
